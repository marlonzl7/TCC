...
<body>
    ...
    <main id="main">
        ...
        <div class="barra">
            <img src="../../assets/images/checkout/checkout-pagamento.png" class="barraIMG">
        </div>
        ...
        <form style="font-family: 'Montserrat', sans-serif" action="..\..\controllers\checkoutController.php" method="POST" autocomplete="on">
                ...
                <div class="informacoes">
                    ...
                    <div id="caixaSelecionaCartao">
                        ...
                        <li class="topico">
                            ...
                            <select id="parcelas" name="parcelas">
                                ...
                                <option value="4"><?php $total4X = (($total + ($total*(15/100)))/4); echo "4X com juros: R$" . number_format($total4X, 2, ',', '.') ?></option>
                                <option value="5"><?php $total5X = (($total + ($total*(30/100)))/5); echo "5X com juros: R$" . number_format($total5X, 2, ',', '.') ?></option>
                    ...
                    <div id="caixaSelecionaPaypal">
                        ...
                        <a href="https://www.paypal.com/br/signin" target="_blank"> 
                            <div class="btnPaypal">
                                <img src="../../assets/images/checkout/paypal.png" class="barraIMG">
                            </div>    
            ...
            <div id="caixaBotoes">
                ...
                <input type="submit" name="entregaPagamentoVoltar" value="Voltar" onclick="salvaPagamentoLocalStorage()" class="btnVoltar">
    ...
    <script src="../../functions/format_checkout.js"></script>
    <script src="../../functions/script_pagamento.js"></script>
